    ...
    <>
      ...
      {showCollapsed && (
        <div className="shrink-0 h-full bg-white flex flex-col items-center py-5 px-2 gap-6 shadow-[0px_2px_4px_0px_rgba(59,37,89,0.1),0px_4px_6px_0px_rgba(59,37,89,0.1)]">
          ...
          <button type="button" className="text-[#777] hover:text-[#070043] cursor-pointer" aria-label={t("logout")}>
            <LogOut size={18} />
          </button>
          ...
          <div className="flex flex-col h-full w-[160px] gap-7">
            <div className="flex flex-col gap-5 items-start w-full">
              <div className="flex flex-col gap-2 items-center w-full">
                ...
                <div className="flex flex-col items-center w-full text-center">
                  <span className="text-base leading-7 text-[#070043] whitespace-nowrap">Penelope Anthony</span>
                  <span className="text-xs leading-6 text-[#777] whitespace-nowrap">name@company.com</span>
                </div>
              </div>
              <button
                type="button"
              ...
              >
                ...
                <span className="text-xs font-medium text-[#777] whitespace-nowrap">{t("logout")}</span>
              </button>
            </div>
            ...
            <div className="flex items-center justify-between w-full mt-auto">
              <div className="flex items-center">
                ...
                <span className="text-sm font-semibold ml-1 whitespace-nowrap">lawbrokr.</span>
              </div>
              {isMobile && (
                <button
                  type="button"
